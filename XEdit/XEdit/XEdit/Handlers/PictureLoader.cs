...
{
    class PictureLoader : Interaction.IHandler
    {
        public string Name => "PictureLoader";
        ...
        private void Perform(object sender, EventArgs args)
        {
            ...
            if (sender is Xamarin.Forms.Layout<Xamarin.Forms.View>)
            {
                (sender as Xamarin.Forms.Layout<Xamarin.Forms.View>).Children.Add(canvasView);
